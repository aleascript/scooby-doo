...
La peur existe, mais elle est drôle. Le danger existe, mais il ne cherche pas à tuer les personnages. Les plans compliqués finissent presque toujours de travers. Et pourtant, d’une manière ou d’une autre, le groupe résout le mystère.
...
- **[Lire les règles](rules.md)** — créez la bande et le Van, découvrez la résolution commune et les quatre Prismes asymétriques.
- **[Jouer Le Mystère du Motel de la Dernière Frite](scenario.md)** — un mystère prêt à jouer pour environ deux heures, création des personnages comprise.
